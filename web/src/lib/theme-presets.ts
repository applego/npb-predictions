...
export const COLOR_THEMES: ColorTheme[] = [
  ...
  // 案A = broadcast（上）。以下は案B/C/D を design トークンから 13 CSS 変数へ移植。
  {
    id: "stadium-night",
    name: "Stadium ナイター",
    description: "暗転 × 緑LED — ナイトゲームのスコアボード（案B）",
    vars: {
      "--bg-base": "#10141B",
      "--bg-surface": "#161C26",
      "--bg-elevated": "#1C2330",
      "--bg-inset": "#0C1018",
      "--border-primary": "#262F3D",
  ...
  },
  {
    id: "newsprint",
    name: "Newsprint 紙面",
    description: "生成り紙 × 深紅 — 活版の予想新聞（案C）",
    vars: {
      "--bg-base": "#F4F1E8",
      "--bg-surface": "#F7F4EC",
      "--bg-elevated": "#EAE5D8",
      "--bg-inset": "#E4DED0",
      "--border-primary": "#CDC6B6",
      "--border-strong": "#191712",
      "--text-primary": "#191712",
      "--text-secondary": "#6A6457",
      "--text-muted": "#9A9385",
      "--stitch": "#8A1F1F",
      "--stitch-light": "#A83232",
      "--field": "#3A5A2E",
  ...
  },
  {
    id: "newspaper-mincho",
    name: "Newspaper 新聞",
    description: "明朝 × 墨一色 — 新聞紙面の総覧（案D）",
    vars: {
      "--bg-base": "#F6F4ED",
      "--bg-surface": "#FAF8F2",
      "--bg-elevated": "#EBE8DE",
      "--bg-inset": "#E4E0D4",
      "--border-primary": "#C7BFAC",
      "--border-strong": "#1A1712",
      "--text-primary": "#1A1712",
      "--text-secondary": "#5F594D",
      "--text-muted": "#938C7C",
      "--stitch": "#1A1712",
      "--stitch-light": "#3A342B",
      "--field": "#2F5A32",
